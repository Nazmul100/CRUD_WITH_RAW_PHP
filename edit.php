...
//var_dump($userInfo['user_photo']);
$oldPhoto = $userInfo['user_photo'];
...
if ($_POST['Submit'] == "update") {
    ...
    if ($photo) {
        ...
        $UpdateData = $getData->Update($id, $username, $oldPhoto, $bio, $skill, $project, $address);
        if ($UpdateData == 1) {
            header('location:index.php');
        }
    }
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group mt-3">
            ...
            <textarea class="form-control" type="text" id="bio" name="bio"
                      rows="3"><?php echo $userInfo['user_bio'] ?></textarea>
        </div>
        ...
        <div class="form-group mt-3">
            ...
            <select class="form-control" id="skill" name="skill">
                ...
                <option value="java" <?= $userInfo['user_skill'] == 'java' ? ' selected="selected"' : ''; ?> >java
                </option>
                <option value="python" <?= $userInfo['user_skill'] == 'python' ? ' selected="selected"' : ''; ?> >
                    python
                </option>
        ...
        <div class="form-group mt-3">
            ...
            <input type="text" class="form-control" id="project"
                   value=<?php echo $userInfo['user_project'] ?> name="project" aria-describedby="nameHelp"
        ...
        <div class="form-group mt-3">
            ...
            <input type="text" class="form-control" id="address"
                   value=<?php echo $userInfo['user_address'] ?> name="address" aria-describedby="nameHelp"
